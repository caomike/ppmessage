...
def _check_debian():
    ...
    dpkg_list = ["apt-file", "git", "mysql-server", "pkg-config", "python-pip", "wget", "gcc", "libffi-dev", "python-dev", "redis-server", "libjpeg8-dev", "libpng12-dev", "libfreetype6-dev", "mercurial", "g++", "libopencore-amrwb-dev", "libopencore-amrnb-dev", "libmp3lame-dev", "libopus-dev", "libmagic", "libpcre3", "libpcre3-dev", "openssl", "libssl-dev"]
