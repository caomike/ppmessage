...
AUTH_URI = "http://localhost:8080/ppauth/token"
...
class AuthCallbackHandler(tornado.web.RequestHandler):
    ...
    def get(self):
        ...
        request = tornado.httpclient.HTTPRequest(AUTH_URI, method="POST", body=body)
    ...
    def createBodyString(self, params):
        body = ""
        for param in params:
